...
>We built that tool to reduce manual steps as we scale and operate the network 
...
## What does Python-access-CLI do ? 
### It automates login and let you interact with a remote device irrespective of the vendor
```
